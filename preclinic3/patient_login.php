...
if(!$con){
	...
	<?php
     if(isset($_POST['qr']))
	{
        header("location:qrcodescanner/docs/patient_QR_scanner.php");
    }
        ...
        <div class="account-box" style="border:2px solid #38c7ff;border-radius:4px;">
            ...
            <div class="account-logo">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autofocus="" class="form-control" name="patient_id" value="<?php echo $qr1;?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-right">
                            <a style="text-decoration:none" href="enter_id.php?table=<?php echo "patient_details"?>&idname=<?php echo "patient_id"?>&redirect=<?php echo "patient_login"?>">Forgot your password?</a>
                        </div>
                        ...
                        <div class="text-center register-link">
                            Don’t have an account? <a href="patient_sign_up.php">Register Now</a>
                        </div>
                    </form>
                </div>
      </div>
