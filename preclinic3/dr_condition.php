      ...
      <label for="note">
        ...
        <?php
                ...
                if(isset($_POST["submit"])){
                  ...
                  $day = $_POST["day"];
				  $date=date('Y-m-d');
                  $insert_query = "INSERT INTO prescription (date,patient_id,id,`diagnosis`, `medicine`, `dosage`, `dosage_type`, `frequency`, `frequency_days`, `tests`, `note`) VALUES ('$date','$id1','$id','$d','$m','$dz','$ds','$f','$day','$t','$n') ";
