...
<body>
    ...
    $q8="SELECT count(id) as s5 FROM patient_1 where TRIM(tests) > '' ;";
    ...
    $q1="select count(id) as s1 from patient_1 where status='active';";
    ...
    $q="SELECT count(id) as s from patient_1;";
   ...
   $query = "SELECT * FROM patient_1 where TRIM(medicine) > '' AND status='active' ";
    ...
    $query1 = "SELECT * FROM allergies_habits where patient_id='2'";
