    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper" style="margin-top:-30px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-id"><?php echo $id  ?><br><br><br><br><br><br><br><br><br></div>
                                                <br>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
            ...
            <center><div>
								  ...
								  <a href="qrcodescanner/docs/lab_dashboard_QR_scanner.php" style="margin-left:-20px;font-size:20px;text-decoration:underline;">Scan QR</a>
                                </div></center>
			</form>
        </div>
    </div>
