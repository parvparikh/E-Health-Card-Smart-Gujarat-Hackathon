...
include "connection.php";
     ...
     $sql5 = "SELECT * FROM laboratory where lab_id = '$id'";
...
<center><br><br><br>
  ...
  <tr><th>Lab Id :<?php echo $lab_id; ?>;</th></tr>
    <tr><th>Lab Name : <?php echo $lab_id; ?>;</th></tr>
      <tr><th>Date : <?php echo date("d/m/y"); ?>;</th></tr>
       ...
       <div class='container'>
            <table border='1' style="background-color:white;width:900px;">
                ...
                <?php 
                 $pid= $_SESSION['pid'];
                $query = "SELECT * FROM $pid where TRIM(tests) > '' ";
                ...
                ?>
                    <tr>
                        ...
                        <td>
       <a style="color: red;"href="edit_lab_report.php?id=<?php echo $id;?>&cid=<?php echo $count?>"><strong>Upload</strong></a></td>
