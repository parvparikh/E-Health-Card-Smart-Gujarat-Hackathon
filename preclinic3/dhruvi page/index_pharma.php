...
<div class='container' >
  ...
  <tr><th  style="color:white;">Medical Id : GetIdHere();</th></tr>
    <tr><th  style="color:white;">Medical Store Name : GetNameHere();</th></tr>
       ...
       <div class='container'>
            <table border='1' style="width:750px;">
              <form action="#" method="post">
                ...
                $query = "SELECT * FROM patient_1 where TRIM(medicine) > '' And taken_from='N/A'";
...
$sql = "UPDATE `patient_1` SET `taken_from`='medical_store_name' WHERE `id`='$selected' "; 
