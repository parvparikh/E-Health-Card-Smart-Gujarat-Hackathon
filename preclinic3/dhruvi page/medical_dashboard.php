        ...
        <div class="page-wrapper" style="margin-top:-80px;">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-6 text-right m-b-30">
                        <a href="medical_edit-profile.php" class="btn btn-primary"><i class="fa fa-plus"></i> Edit Profile</a>
                    </div>
                </div>
            ...
            <center><div>
                                  <label style="font-size:20px;margin-left:700px;">Enter Patient ID:</label>
                                   <input type="text" name="patient_id" style="height:32px;"><!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->&nbsp;&nbsp;&nbsp;<button name="submit" value="Submit" class="btn btn-primary" style="width:120px;height:34px;margin-left: -10;margin-left: -10;margin-right: 59px;"><a href="index_pharma.php" style="color:white;">Submit</a></button><br><a href="#" style="margin-left:850px;font-size:20px;text-decoration:underline;">Scan QR</a>
                                </div></center>
                                <br>
        </div>
    </div>
