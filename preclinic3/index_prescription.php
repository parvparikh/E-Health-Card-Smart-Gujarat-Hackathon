    ...
    <div class="login-popup">
      <div class="form-popup" id="popupForm">
        ...
        <form  action="#" method="post"  class="form-container">
          ...
          <tr>
            <th colspan="2">
          <h2>Prescription</h2><h4 style="float: left;">Date:<?php echo date('d/m/y');?></h4><h4 style="float: right;">Id:visit_
	   <?php 
	   $id1 = $_SESSION['pid'];
...
<h5 style="float: left;padding: ">Patient Id:<?php echo " $id1 ";?></h5><h5 style="float: right;">Doctor Id:<?php echo "DrId fetch here";?></h5>
      ...
      <label for="note">
        ...
        <?php
                ...
                if(isset($_POST["submit"])){
                  ...
                  $f = $_POST["frequency"];
                  $day = $_POST["day"];
                  $pb = "get_session_dr_id_here";
				  $date=date('Y-m-d');
                  $insert_query = "INSERT INTO prescription (date,patient_id,id,`diagnosis`, `medicine`, `dosage`, `dosage_type`, `frequency`, `frequency_days`,`prescribed_by`, `tests`, `note`) VALUES ('$date','$id1','$id','$d','$m','$dz','$ds','$f','$day','$pb','$t','$n') ";
