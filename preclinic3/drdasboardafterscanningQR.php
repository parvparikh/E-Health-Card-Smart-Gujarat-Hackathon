    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper" style="margin-top:-10px;">
			...
			<form method="post" action="#">
                                  ...
                                  <input type="text" name="patient_id" style="height:32px;" value="<?php echo $_POST['qr'];?>">&nbsp;&nbsp;&nbsp;
								  ...
								  <a href="#" style="margin-left:-20px;font-size:20px;text-decoration:underline;">Scan QR</a>
                                </div></center>
			</form>
