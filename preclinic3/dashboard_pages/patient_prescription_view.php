      ...
      <div class="header-left">
       ...
       <a id="toggle_btn" href="javascript:void(0);"><i class="fa fa-bars"></i></a>
        ...
        <center><br><br><br><br><br><br>
          <div style="background-color:powderblue;width:800px;margin-left:15%; ">
          <form action="#" method="post" class="form-container" style="width:400px;height:150px;margin-left:-400px;">
                <input type="date" name="date" value="<?php echo date('d-m-Y');?>"> <input type="submit" name="submit">
       ...
       <div class="container" style="width:800px;">
            <table border="1" style="width:750px;">
                ...
                $query = "SELECT * FROM patient_1 where TRIM(medicine) > '' AND `date`='$dt' ";
