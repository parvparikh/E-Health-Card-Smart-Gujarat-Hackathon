    ...
    <div class="login-popup">
      <div class="form-popup" id="popupForm">
        ...
        <form  action="#" method="post"  class="form-container">
          ...
          <tr>
            <th colspan="2">
          <h2>Prescription</h2><h4 style="float: left;">Date:<?php echo date("d/m/y");?></h4><h4 style="float: right;">Id:visit_<?php $sql = " SELECT count(`id`) FROM `patient_1`";
      $res4 = mysqli_query($con, $sql);
      $row4 = mysqli_fetch_array($res4); echo $row4[0]+1; ?></h4></th></tr><tr><th colspan="2">

<h5 style="float: left;padding: ">Patient Id:<?php echo "Pid fetch here";?></h5><h5 style="float: right;">Doctor Id:<?php echo "DrId fetch here";?></h5>
<h5 style="float: left;">Patient Name:<?php echo "PName fetch here";?></h5><h5 style="float: right;">Doctor Name:<?php echo "DrName fetch here";?></h5>
   </th> </tr><tr>
      <td>
          <label for="diagnosis">
          <strong>Diagnosis</strong>
          </label></td><td>
          <input list="Diagnosis" style="width: 80%;" placeholder="Enter Diagnosis" name="Diagnosis" type="text" required/>
          <datalist id="Diagnosis">
            <?php  
             while($row2 = mysqli_fetch_array($res2)){  
            echo '<option value="'.$row2['Diseases'].'">'.$row2['Diseases'].'</option>';   }
             ?>
          </datalist></td></tr><tr><td>
            <label for="medicine">
      ...
      <label for="note">
        ...
        <?php
                ...
                if(isset($_POST["submit"])){
                  ...
                  $f = $_POST["frequency"];
                  $day = $_POST["day"];
 $insert_query = "INSERT INTO `patient_1`(`diagnosis`, `medicine`, `dosage`, `dosage_type`, `frequency`, `frequency_days`, `tests`, `note`) VALUES ('$d','$m','$dz','$ds','$f','$day','$t','$n') ";
      ...
      function closeForm() {
       ...
       <div class='container' style="margin-top:1px;margin-left:303px;">
            <table border='1' style="background-color:powderblue;width:900px;" >
                ...
                ?>
                    <tr>
                        <td align='center' style="width:100px;"><?php echo $count; ?></td>
