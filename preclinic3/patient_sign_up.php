...
elseif($y==1){
 ...
 elseif($x==1){
	echo '<script>alert("Phone number Already Exists!!");</script>';
		...
		if($value==0 && $y==0 && $x==0){
        $sql = "INSERT INTO patient_details (patient_id,fname,mname,lname,DOB,contact_no,email,gender,blood_group,height,weight,address,city,state,district,pincode,password,marital_status,qr_path) VALUES ('$pid','$fname','$mname','$lname','$dob','$phone1','$email','$gender','$bg','$h','$w','$add','$city','$state','$district','$pincode','$pass','$ms','$file')";
