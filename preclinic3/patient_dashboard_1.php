...
<body>
    ...
    $q8="SELECT count(id) as s5 FROM $id where TRIM(tests) > '' ;";
    ...
    $q1="select count(id) as s1 from $id where status='active';";
    ...
    $q="SELECT count(id) as s from $id;";
   ...
   $query = "SELECT * FROM $id where TRIM(medicine) > '' AND status='active' ";
    ...
    $query1 = "SELECT * FROM allergies_habits where patient_id='$id'";
