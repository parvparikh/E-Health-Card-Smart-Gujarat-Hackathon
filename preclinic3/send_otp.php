...
require 'plugins/PHPMailer/src/SMTP.php';
		function unique_code()
			...
			try {
				...
				$mail->Body    = '<fieldset style="border: 2px inset;"><center><h2 style="color:blue;">Health Card</h2><h3>Your verification code for Diagnosis Kindly note this otp is only valid for 60 seconds</h3><br><h1><i><b>'.$_SESSION['otp'].'</i></b></h1><br></center></fieldset>';
				$mail->send();
				$_SESSION['start'] = time();
